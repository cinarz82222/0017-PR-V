...
module.exports = async function Invasion(client, member, luhux, channel) {
    ...
    if (fakeAccounts >= 7) {
        if (luhux.systems.invasion) return true;
        luhux.systems.invasion = true;
        member.guild?.updateSettings({
            system: luhux.systems
        });
