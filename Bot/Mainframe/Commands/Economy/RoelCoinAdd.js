...
module.exports = {
    Name: 'roelcoinadd',
    Aliases: ['roelyükle', 'roelekle'],
    Description: 'Bir üyeye dilediğiniz miktarda RoelCoin eklersiniz.',
    Usage: 'roelcoinadd <@User/ID> <miktar>',
    Category: 'Root',
    Cooldown: 0,
    ...
    messageRun: async (client, message, args) => {
        ...
        document.inventory.roelcoin += Number(args[1])
        document.markModified('inventory')
        await document.save()

        message.reply({ content: `Başarıyla ${member} kullanıcısının bankasına ${client.functions.formatNumber(args[1])} RoelCoin yüklediniz.` })
    },
};
