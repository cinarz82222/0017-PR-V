const { bold, codeBlock, EmbedBuilder } = require('discord.js')
...
module.exports = {
    ...
    messageRun: async (client, message, args, luhux) => {
        ...
        if (!client.staff.check(member, luhux)) return;
        ...
        const row = new ActionRowBuilder({
            components: [
                new ButtonBuilder({
                    ...
                    disabled: !document.authBlock ? true : false,
                }),
                new ButtonBuilder({
                    custom_id: 'unblock',
        ...
        const embed = new EmbedBuilder({
            ...
            description: [
                ...
                '',
                `${bold('Kullanıcı:')} ${member.user.tag} (${member.id})`,
                `${bold('Sebep:')} ${reason}`,
