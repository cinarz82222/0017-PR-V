    ...
    messageRun: async (client, message, args, luhux) => {
        ...
        collector.on('collect', async (i) => {
            ...
            if (data.type === 'ChatMute') {
                member.roles.remove(luhux.settings.chatMuteRole);
            } else if (data.type === 'VoiceMute') {
                if (member.voice.channel) member.voice.setMute(false);
                member.roles.remove(luhux.settings.voiceMuteRole);
            } else if (data.type === 'Event') {
                member.roles.remove(luhux.settings.eventPenaltyRole);
            } else if (data.type === 'Streamer') {
                member.roles.remove(luhux.settings.streamerPenaltyRole);
