...
module.exports = async function Merhaba(client, message, option, luhux, question, author, menu = 'main', functionType) {
    await question.edit({
    ...
    collector.on('collect', async (i) => {
        ...
        if (i.isChannelSelectMenu()) {
            if (option.isMultiple) {
                luhux[option.root][option.value] = i.values;
            } else {
                luhux[option.root][option.value] = i.values[0];
            }
