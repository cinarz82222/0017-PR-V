...
function updatePresence(client) {
  let message = client.system.Presence.Message[0] ? client.system.Presence.Message[Math.floor(Math.random() * client.system.Presence.Message.length)] : 'luhux was here';
    ...
    activities: [
      {
        ...
        url: 'https://www.twitch.tv/luhuxcuk'
      },
    ],
  });
}
