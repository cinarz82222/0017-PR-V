...
class luhuxClient extends Client {
    ...
    async spawn() {
        ...
        const Commands = new FileManager({
            Folder: 'Commands',
            Type: 'Command',
            Load: this.luhux.Commands || false
        });
        ...
        return super.login(this.luhux.Token).then(app => {
